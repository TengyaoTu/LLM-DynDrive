...
def worker(rank, world_size, args):
    ...
    for i in my_indices:
        ...
        hidden_save_path = os.path.join(output_dir, f"hidden_rank{rank}_{hidden_offset}.pt")
        try:
            save_qwen2_think_split_tokens_only(model, tokenizer, full_inputs["input_ids"], full_text, hidden_save_path)
